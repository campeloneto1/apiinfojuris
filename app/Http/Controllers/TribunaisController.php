...
class TribunaisController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($data->save()){
            ...
            $log->object = $data;
            $log->save();
            return response()->json('Tribunal cadastrado com sucesso!', 200);
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($data->save()){
            ...
            $log->save();
            return response()->json('Tribunal editado com sucesso!', 200);
        }else{
    ...
    public function destroy($id)
    {
        $data = Tribunal::find($id);
         ...
         if($data->delete()){
            ...
            $log->object = $data;
            $log->save();
            return response()->json('Tribunal excluído com sucesso!', 200);
          }else{
